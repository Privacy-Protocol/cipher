...
import {
    IProposalManager
} from "../../DaoToolkit/interface/IProposalManager.sol";
...
contract DemoDao is ReentrancyGuard {
    ...
    function createProposal(
        ...
        PROPOSAL_MANAGER.propose(proposalId, 3, uint64(VOTING_PERIOD));
    ...
    function vote(
        ...
        // Relay the footprint to ProposalManager.
        PROPOSAL_MANAGER.submitEncryptedVote(proposalId, support);
    ...
    function hasReachedQuorum(uint256 proposalId) public returns (bool) {
        ...
        uint[] memory counts = PROPOSAL_MANAGER.tallyEncryptedVotes(proposalId);
